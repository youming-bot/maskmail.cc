/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 3ac51768de2bccc94cfc30f42d261034)
// Runtime types generated with workerd@1.20250913.0 2025-03-01 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		BETTER_AUTH_SECRET: "secret-placeholder";
		BETTER_AUTH_URL: "http://localhost:3000";
		GOOGLE_CLIENT_ID: "google-client-id-placeholder";
		GOOGLE_CLIENT_SECRET: "google-client-secret-placeholder";
		maskmail_bucket: R2Bucket;
		maskmail_db: D1Database;
		ASSETS: Fetcher;
	}
}
